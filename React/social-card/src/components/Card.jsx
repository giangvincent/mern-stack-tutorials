        ...
        <div className="mt-2">
          ...
          <div className="py-2 flex flex-row items-center">
            <button className="flex flex-row items-center focus:outline-none focus:shadow-outline rounded-lg">
              ...
              <span className="ml-1">{this.props.data.numLike}</span>
            </button>
            <button className="flex flex-row items-center focus:outline-none focus:shadow-outline rounded-lg ml-3" >
              ...
              <span className="ml-1">{this.props.data.numCmt}</span>
            </button>
            <button className="flex flex-row items-center focus:outline-none focus:shadow-outline rounded-lg ml-3">
              <svg
                fill="none"
              ...
              <span className="ml-1">{this.props.data.numShare}</span>
            </button>
          </div>
        </div>
        <div className="py-2">
          <p className="leading-snug">{this.props.data.description}</p>
        </div>
      </div>
    );
  }
